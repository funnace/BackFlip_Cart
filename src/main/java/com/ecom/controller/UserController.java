...
public class UserController {
	...
	public String saveOrder(@ModelAttribute OrderRequest request, Principal principal) throws Exception {
	    // Ensure the Principal is not null
	    if (principal == null) {
	        return "redirect:/error"; // Redirect to an error page if no user is logged in
	    }
	...
	public String loadSuccess() {
	    return "/user/success"; // Ensure this path is correct based on your view resolver
	}
